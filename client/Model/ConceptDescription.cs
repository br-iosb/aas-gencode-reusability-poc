...
namespace AAS.Client.Model
{
        ...
        public partial class ConceptDescription : Identifiable,  IEquatable<ConceptDescription>, IValidatableObject
    {
        ...
        public ConceptDescription(List<Reference> isCaseOf = default(List<Reference>), List<EmbeddedDataSpecification> embeddedDataSpecifications = default(List<EmbeddedDataSpecification>), AdministrativeInformation administration = default(AdministrativeInformation), string identification = default(string)) : base(administration, identification)
        {
