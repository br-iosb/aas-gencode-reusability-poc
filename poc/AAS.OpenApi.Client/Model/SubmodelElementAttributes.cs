...
namespace AAS.OpenApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SubmodelElementAttributes : Referable,  IEquatable<SubmodelElementAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubmodelElementAttributes" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SubmodelElementAttributes);
        }

        /// <summary>
        /// Returns true if SubmodelElementAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of SubmodelElementAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubmodelElementAttributes input)
        {
            if (input == null)
                return false;
