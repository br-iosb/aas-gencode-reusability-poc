...
namespace AAS.OpenApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModelReference :  IEquatable<ModelReference>, IValidatableObject
    {
        /// <summary>
        ...
        public ModelReference(GlobalReference referredSemanticId = default(GlobalReference), List<Key> keys = default(List<Key>))
        {
