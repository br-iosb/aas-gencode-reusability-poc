...
namespace AAS.OpenApi.Client.Model
{
        ...
        public partial class DataSpecificationIEC61360Content : ValueObject,  IEquatable<DataSpecificationIEC61360Content>
    {
        ...
        public DataSpecificationIEC61360Content(DataTypeEnum? dataType = default(DataTypeEnum?), List<LangString> definition = default(List<LangString>), List<LevelType> levelType = default(List<LevelType>), List<LangString> preferredName = default(List<LangString>), List<LangString> shortName = default(List<LangString>), string sourceOfDefinition = default(string), string symbol = default(string), string unit = default(string), Reference unitId = default(Reference), string valueFormat = default(string), ValueList valueList = default(ValueList), string value = default(string), Reference valueId = default(Reference), ValueTypeEnum valueType = default(ValueTypeEnum)) : base(value, valueId, valueType)
        {
