...
using System;
using System.IO;
using AAS.OpenApi.Server.Filters;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("V1.0RC01", new OpenApiInfo
                    {
                        Version = "V1.0RC01",
                    ...
                    c.IncludeXmlComments($"{AppContext.BaseDirectory}{Path.DirectorySeparatorChar}{typeof(AAS.OpenApi.Server.Models.AssetAdministrationShell).Assembly.GetName().Name}.xml");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/V1.0RC01/swagger.json", "DotAAS Part 2 | HTTP/REST | Entire Interface Collection");
